...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/imanuelpardosi/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'imanuelpardosi' => 'ipardosi@dyned.com' }
  s.source           = { :git => 'https://github.com/imanuelpardosi/BlinkingLabel.git', :tag => s.version.to_s }
